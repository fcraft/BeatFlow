...
| `CmdQuickActions` | `virtual-human-v2/CmdQuickActions.vue` | 快捷操作栏：运动/情绪/病变/用药/体内/紧急 + 6 个临床场景预设卡片，全行状态高亮 |
